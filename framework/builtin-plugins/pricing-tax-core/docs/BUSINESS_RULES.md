# Pricing & Tax Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `pricing-tax-core` and its owned resource set.
...
- ERP parity references are tracked against: `Accounts`, `Selling`, `Buying`, `Stock`.
