...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Pricing & Tax Control Room"),
    React.createElement("p", null, "Commercial rules, tax policy, and effective-date governance for quote, order, and billing lifecycles."),
    React.createElement(
      "p",
      null,
