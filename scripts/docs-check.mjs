...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/pricing-tax-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-pricing-tax-core:");
...
console.log("Documentation check passed for gutu-plugin-pricing-tax-core.");
